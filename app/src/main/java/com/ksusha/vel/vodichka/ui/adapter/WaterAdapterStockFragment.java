...
public class WaterAdapterStockFragment extends RecyclerView.Adapter<WaterAdapterStockFragment.WaterViewHolder> {

    Context context;
    List<WaterEntity> waters;
    RecyclerviewOnClickListener listener;

    public WaterAdapterStockFragment(RecyclerviewOnClickListener listener, List<WaterEntity> waters) {
        this.waters = waters;
